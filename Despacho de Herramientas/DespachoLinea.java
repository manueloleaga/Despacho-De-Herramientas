...
public class DespachoLinea extends JDialog{
	...
	public DespachoLinea( JFrame ventana, String titulo,boolean comportamiento, JTable tblHerramienta,DefaultTableModel modeloHerramienta){
	...
	public void gui(){
		panelArriba = new JPanel();
			...
			lblEncabezado = new JLabel("Prestar Herramienta", JLabel.CENTER);
		...
		panelCentro = new JPanel();	
			...
			//	lblHerramienta.setForeground(verde);
				...
				String arg [] = {"Hola", "dadasd"};
			cbbNumItem = new JComboBox(arg);//AGREGAR HERRAMIENTA EXISTENTE MEDIANTE UNA CONSULTA A BD
			...
			lblCantidad= new JLabel("Cantidad:  ");		cbbCantidad = new JComboBox();
				...
				lblCantidad.setFont(letraLabel);		cbbCantidad.setFont(letraLabel); cbbCantidad.setBackground(Color.WHITE);
		...
		panelAbajo = new JPanel();
			...
			panelAbajo.setLayout(new FlowLayout(FlowLayout.CENTER));
				btnAceptar = new JButton("Aceptar"); btnAceptar.setActionCommand("Prestar");
